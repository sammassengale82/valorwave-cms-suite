...
export function FooterSection(props: any) {
  return (
    <footer data-theme-scope="all">
      ...
      {props["footer-line-1"] && (
        <p
          data-ve-edit="footer-line-1"
          dangerouslySetInnerHTML={{ __html: props["footer-line-1"].html }}
        />
      )}

      {props["footer-line-2"] && (
        <p
          data-ve-edit="footer-line-2"
          dangerouslySetInnerHTML={{ __html: props["footer-line-2"].html }}
        />
      )}

      {props["footer-line-3"] && (
        <p
          data-ve-edit="footer-line-3"
          dangerouslySetInnerHTML={{ __html: props["footer-line-3"].html }}
        />
      )}

      {props["footer-line-4"] && (
        <p
          data-ve-edit="footer-line-4"
          dangerouslySetInnerHTML={{ __html: props["footer-line-4"].html }}
        />
      )}

      {/* Socials here are static in this implementation */}
      <div
